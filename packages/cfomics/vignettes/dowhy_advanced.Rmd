...
**Note:** This vignette demonstrates advanced features that require Python with DoWhy
installed. All code examples are shown for reference but not executed (`eval=FALSE`).
To run these examples interactively, first set up your Python environment as described
in the "Python Environment Setup" vignette.
